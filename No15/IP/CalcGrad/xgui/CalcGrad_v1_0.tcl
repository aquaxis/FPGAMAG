...
proc update_PARAM_VALUE.ap_const_lv8_8 { PARAM_VALUE.ap_const_lv8_8 } {
	# Procedure called to update ap_const_lv8_8 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ap_const_lv8_8 { PARAM_VALUE.ap_const_lv8_8 } {
	# Procedure called to validate ap_const_lv8_8
	return true
}
...
proc update_MODELPARAM_VALUE.ap_const_lv8_8 { MODELPARAM_VALUE.ap_const_lv8_8 PARAM_VALUE.ap_const_lv8_8 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ap_const_lv8_8}] ${MODELPARAM_VALUE.ap_const_lv8_8}
}
