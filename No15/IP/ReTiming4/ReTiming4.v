         ...
         if(buf_hsync & !buf_hsync_d) begin
            ...
            if(w_hup) begin
               if(precount1[2:0] == 3'd4) begin
                  precount1[2:0] <= 3'd0;
				  if(precount2_1[2:0] == 3'd4) begin
					 precount2[7:0] <= precount2[7:0] + 8'd5;
					 precount2_1[2:0] <= 3'd0;
				  end else begin
					 precount2_1[2:0] <= precount2_1[2:0] + 3'd1;
				  end
               end else begin
...
//                  end
         ...
         if((hcount[11:0] == `RETIMING_H) && (precount3[2:0] == 3'd4)) begin
            buf_restart_h <= 1'b1;
         end else begin
            buf_restart_h <= 1'b0;
         end
   ...
   assign ADRS[7:0] = precount2[7:0]+precount1[2:0];
   assign ADRS[9:8] = bank[1:0];
   assign VALID = (href && precount2_1[2:0] == 3'd1)?1'b1:1'b0;
   assign SEL = (precount3[2:0] != 3'd0)?1'b1:1'b0;
