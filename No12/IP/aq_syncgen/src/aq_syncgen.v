...
/* 800x480@60Hz(29.59MHz) */
/*
localparam HSYNC_MAX    = 976;
localparam HSYNC_ACTIVE = 800;
localparam HSYNC_START  = 832;
localparam HSYNC_END    = 944;
localparam VSYNC_MAX    = 525;
localparam VSYNC_ACTIVE = 480;
localparam VSYNC_START  = 497;
localparam VSYNC_END    = 499;
...
localparam SYNC_REV     = 1;
*/
/* 1280x1024@75Hz(135MHz) */
/*
localparam HSYNC_MAX    = 1688;
localparam HSYNC_ACTIVE = 1280;
localparam HSYNC_START  = 1296;
localparam HSYNC_END    = 1440;
localparam VSYNC_MAX    = 1066;
localparam VSYNC_ACTIVE = 1024;
localparam VSYNC_START  = 1025;
...
/*
localparam HSYNC_MAX    = 1650;
localparam HSYNC_ACTIVE = 1280;
localparam HSYNC_START  = 1390;
localparam HSYNC_END    = 1430;
localparam VSYNC_MAX    = 750;
localparam VSYNC_ACTIVE = 720;
