  ...
  always @(posedge CLK or negedge RST_N) begin
    if(!RST_N) begin
      ...
      if(rd_ena) begin
        case(LOCAL_ADDR[7:0] & 8'hFC)
          A_WR_START: begin
            reg_rdata[31:0] <= {12'd0, WR_FIFO_AEMPTY, WR_FIFO_EMPTY, WR_FIFO_AFULL, WR_FIFO_FULL, 7'd0, WR_READY, 7'd0, reg_wr_start};
          end
          A_WR_ADRS: begin
          ...
          A_RD_START: begin
            reg_rdata[31:0] <= {12'd0, RD_FIFO_AEMPTY, RD_FIFO_EMPTY, RD_FIFO_AFULL, RD_FIFO_FULL, 7'd0, RD_READY, 7'd0, reg_rd_start};
          end
          A_RD_ADRS: begin
